module.exports = {
  projects: [
    ...
    '<rootDir>/libs/feature/information',
    ...
    '<rootDir>/libs/information/use-type/data-access/store',
    '<rootDir>/libs/information/use-type/main',
    ...
    '<rootDir>/libs/information/information/main',
    '<rootDir>/libs/information/information/data-access/store',
    '<rootDir>/libs/shared/util/utility',
    '<rootDir>/libs/information/use-state/data-access/store',
    '<rootDir>/libs/information/use-state/main',
  ],
};
