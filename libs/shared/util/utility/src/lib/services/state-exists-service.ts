...
export abstract  class StateExistsService<T>  {
  private _collectionService: EntityCollectionService<T>;
  private _router: Router;

  constructor( injector: Injector,
  ) {
    this._collectionService = injector.get(EntityServices).getEntityCollectionService(this.entityName());
